...
# ANALYTICS_TRACKING_ID = google['analytics'].freeze	# ANALYTICS_TRACKING_ID = google['analytics'].freeze
# GEOCODING_API_KEY = google['geocoding']['api_key']	# GEOCODING_API_KEY = google['geocoding']['api_key']
# RECAPTCHA_SITEKEY = google['recaptcha']['sitekey']	# RECAPTCHA_SITEKEY = google['recaptcha']['sitekey']
# RECAPTCHA_SECRETKEY = google['recaptcha']['secretkey']	# RECAPTCHA_SECRETKEY = google['recaptcha']['secretkey']
# RECAPTCHA_VERIFY_URL = google['recaptcha']['verifyUrl']	# RECAPTCHA_VERIFY_URL = google['recaptcha']['verifyUrl']
...
# ENV['GOOGLE_ANALYTICS']	# ENV['GOOGLE_ANALYTICS']
# redis = APP_CONFIG[env]['redis'].freeze	# redis = APP_CONFIG[env]['redis'].freeze
