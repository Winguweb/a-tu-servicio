...
### Added
  ...
  - `app/cells/components/compare_provider_button/compare_provider_button.js`
  - `app/cells/components/compare_provider_button/compare_provider_button.scss`
  - `app/cells/components/compare_provider_button/show.slim`
  - `app/cells/components/compare_provider_button_cell.rb`
  - `app/cells/components/provider_detail_half_left/provider_detail_half_left.js`
  - `app/cells/components/provider_detail_half_left/provider_detail_half_left.scss`
  - `app/cells/components/provider_detail_half_left/show.slim`
  - `app/cells/components/provider_detail_half_left_cell.rb`
  - `app/cells/components/provider_detail_half_right/provider_detail_half_right.js`
  - `app/cells/components/provider_detail_half_right/provider_detail_half_right.scss`
  - `app/cells/components/provider_detail_half_right/show.slim`
  - `app/cells/components/provider_detail_half_right_cell.rb`
  - `app/cells/components/provider_list_half_right/provider_list_half_right.js`
  - `app/cells/components/provider_list_half_right/provider_list_half_right.scss`
  - `app/cells/components/provider_list_half_right/show.slim`
  - `app/cells/components/provider_list_half_right_cell.rb`
...
### Added
  ...
  - `app/cells/components/provider_detail_large/provider_detail_large.js`
  - `app/cells/components/provider_detail_large/provider_detail_large.scss`
  - `app/cells/components/provider_detail_large/show.slim`
  ...
  - `app/cells/components/provider_detail_large_cell.rb`
